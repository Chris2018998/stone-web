...
public class ObjectSourceBeansRegister<K, V> implements EnvironmentAware, ImportBeanDefinitionRegistrar {
    ...
    public final void registerBeanDefinitions(AnnotationMetadata classMetadata, BeanDefinitionRegistry registry) {
        ...
        Set<String> osIdList = getOsIdList(environment, registry);
     ...
     */
    private Set<String> getOsIdList(Environment environment, BeanDefinitionRegistry registry) {
        ...
        Set<String> dsIdList = new HashSet<>(osIds.length);
        for (String id : osIds) {
     ...
     * @return ObjectSource name list
     */
    private Properties getDynamicOsInfo(Set<String> osIdList, Environment environment, BeanDefinitionRegistry registry) {
     ...
     */
    private Map<String, ObjectSourceBean<K, V>> createObjectSourceBean(Set<String> osIdList, Environment environment) {
    ...
    private void registerObjectSourceBean(Map<String, ObjectSourceBean<K, V>> osMap, Properties dynProperties, BeanDefinitionRegistry registry) {
        ...
        if (!isBlank(dynOsId) && !isBlank(primaryOsId)) {
