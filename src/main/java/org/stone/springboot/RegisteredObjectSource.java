 ...
 * @author Chris Liao
 */
public final class RegisteredObjectSource {
    private final static Logger Log = LoggerFactory.getLogger(RegisteredObjectSource.class);
    ...
    RegisteredObjectSource(String osId, BeeObjectSource os) {
        this.osId = osId;
        this.os = os;
