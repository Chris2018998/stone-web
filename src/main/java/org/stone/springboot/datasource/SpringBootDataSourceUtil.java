...
public class SpringBootDataSourceUtil {
    ...
    private static SpringBootGlobalConfig monitorConfig;
    //***************************************************************************************************************//
    ...
    //***************************************************************************************************************//
    public synchronized static SpringBootGlobalConfig readMonitorConfig(Environment environment) {
        if (monitorConfig == null) {
            //1:create sql sqlTrace config instance
            monitorConfig = new SpringBootGlobalConfig();
            //2:set Properties
            setConfigPropertiesValue(monitorConfig, Config_DS_Prefix, null, environment);
            //3:create global json tool()
            createJsonTool(monitorConfig.getJsonToolClassName());
        }
    ...
    //                               4: other(2)                                                                     //
    //***************************************************************************************************************//
    public static void tryToCloseDataSource(Object ds) {
