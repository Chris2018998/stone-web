...
public class SpringBootDataSourceUtil {
    ...
    private static DsMonitorConfig monitorConfig;
    //***************************************************************************************************************//
    ...
    //***************************************************************************************************************//
    public synchronized static DsMonitorConfig readMonitorConfig(Environment environment) {
        if (monitorConfig == null) {
            //1:create sql sqlTrace config instance
            monitorConfig = new DsMonitorConfig();
            //2:set Properties
