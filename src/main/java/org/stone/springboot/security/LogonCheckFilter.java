...
public class LogonCheckFilter implements Filter {
    ...
    private final String[] restUrls = {"/stone/beecp/getDataSourceList", "/stone/beecp/getSqlTraceList", "/stone/beecp/restartDataSource"};

    LogonCheckFilter(String userId, String loggedInTagName) {
        this.userId = userId;
