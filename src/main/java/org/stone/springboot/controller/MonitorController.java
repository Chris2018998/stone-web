...
public class MonitorController {
    ...
    public RestfulResponse getDataSourceList() {
        try {
            ...
            return new RestfulResponse(RestfulResponse.CODE_FAILED, e, "Failed to 'getDataSourceList'");
        }
    }
    ...
    public RestfulResponse getSqTraceList() {
        try {
            ...
            return new RestfulResponse(RestfulResponse.CODE_FAILED, e, "Failed to 'getSqlTraceList'");
        }
    }
    ...
    public RestfulResponse clearDsConnections(@RequestBody Map<String, String> parameterMap) {
        try {
            ...
            return new RestfulResponse(RestfulResponse.CODE_FAILED, e, "Failed to 'clearDsConnections'");
        }
    }
}
