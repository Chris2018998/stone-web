 ...
 * @author Chris Liao
 */
public class MonitorRegister implements EnvironmentAware, ImportBeanDefinitionRegistrar {
    ...
    public final void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        if (!SpringBootDataSourceUtil.existsBeanDefinition(resetControllerRegName, registry)) {
            ...
            define.setInstanceSupplier(SpringBootDataSourceUtil.createSpringSupplier(new MonitorController()));
