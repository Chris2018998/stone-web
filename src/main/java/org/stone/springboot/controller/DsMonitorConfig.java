 ...
 *  controller config
 *
 * spring.datasource.controller-userId=admin
 * spring.datasource.controller-password=admin
 *
...
public class DsMonitorConfig {
    ...
    //*********************************controller config begin **********************************************************//
    private String monitorUserId;
    private String monitorPassword;
    private String monitorLoggedInTagName = DsMonitorController.class.getName();
