 ...
 * @author Chris Liao
 */
public final class RegisteredDataSource implements DataSource {
    private final static Logger Log = LoggerFactory.getLogger(RegisteredDataSource.class);
    ...
    RegisteredDataSource(String dsId, DataSource ds, boolean jndiDs) {
        this.dsId = dsId;
        this.ds = ds;
        this.jndiDs = jndiDs;
