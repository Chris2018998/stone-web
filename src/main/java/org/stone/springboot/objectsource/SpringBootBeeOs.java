 ...
 * @author Chris Liao
 */
public class SpringBootBeeOs {
    private final static Logger Log = LoggerFactory.getLogger(SpringBootBeeOs.class);
    ...
    SpringBootBeeOs(String osId, BeeObjectSource os) {
        this.osId = osId;
        this.os = os;
