 ...
 * @author Chris Liao
 */
public final class StoneRegisteredManager {
    ...
    void init(StoneSpringbootConfig config) {
        ...
        if (config.isSqlTrace()) {
            ...
            this.timerExecutor = new ScheduledThreadPoolExecutor(1, new SpringBootDsThreadFactory());
    ...
    public void addDataSource(RegisteredDataSource ds) {
        ...
        ds.setTraceSql(config.isSqlTrace());
    }
    ...
    private static final class SqlTraceTimeoutTask implements Runnable {
        ...
        private final StoneRegisteredManager manager;
        private final LinkedList<StatementTrace> sqlAlertTempList;

        public SqlTraceTimeoutTask(StoneRegisteredManager manager, long sqlTraceTimeout) {
