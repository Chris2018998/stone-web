 ...
 * @author Chris Liao
 */
public final class SpringSourceMonitorManager {
    private static final SpringSourceMonitorManager single = new SpringSourceMonitorManager();
    ...
    private SpringSourceMonitorManager() {
        this.dsMap = new ConcurrentHashMap<>(1);
        this.osMap = new ConcurrentHashMap<>(1);
    }

    public static SpringSourceMonitorManager getInstance() {
        return single;
    }
