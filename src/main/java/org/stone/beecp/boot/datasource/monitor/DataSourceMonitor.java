 ...
 */
package org.stone.beecp.boot.datasource.monitor;

import org.springframework.stereotype.Controller;
import org.springframework.web.bind.annotation.*;
import org.stone.beecp.boot.datasource.SpringBootDataSourceManager;
import org.stone.beecp.boot.datasource.SpringBootDataSourceUtil;
...
public class DataSourceMonitor {
    ...
    public SpringBootRestResponse clearDsConnections(@RequestBody Map<String, String> parameterMap) {
        try {
            ...
            return new SpringBootRestResponse(SpringBootRestResponse.CODE_FAILED, e, "Failed to 'clearDsConnections'");
        }
    }
}
